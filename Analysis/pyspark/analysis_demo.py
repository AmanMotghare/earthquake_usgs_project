...
spark = (SparkSession.builder.master('local[*]')
         .appName('analyzing demo earthquake data using pyspark.')
         .getOrCreate())
print(f"Spark Session Initialized!! {spark}")

# Load parquet data to dataframe
earthquake_data = spark.read.parquet(r"D:\BrainWorks\Pyspark Assignments\earthquake_ingestion\Analysis"
                                     r"\demo_earthquake_data\earthquake_data.parquet")

earthquake_data.cache()
