...
google_cloud_options.job_name = "bq-table-analysis-using-dataflow-que1"
...
outputFilePath = "gs://earthquake_usgs_bucket/Dataflow/analysis/analyzed_data/que1/que1"

parquet_schema = pa.schema([
    ("region", pa.string()),
    ("total_earthquakes", pa.float64())
])
